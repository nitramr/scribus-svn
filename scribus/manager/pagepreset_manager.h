...
{
	int pageUnitIndex {-1};
	int layout {-1}; // -1 = undefinded, 0 = single, 1 = double
	int firstPage {-1}; // -1 = undefinded, 0 = left, 1 = right
	double width {0.0};
	double height {0.0};
	int bindingDirection {-1}; // -1 = undefinded, 0 = LTR, 1 = RTL
	QString displayName {"undefined"};
	QString name {"undefined"}; // original name
	QString id;
	QString label;
...
private:
	...
	bool hasValidVersion(const QString &version) const;
